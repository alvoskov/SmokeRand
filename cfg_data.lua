...
local gen_sources = {
    ...
    'mwc64x',             'mwc8222',      'pcg32',         'pcg32_xsl_rr',
    ...
    'superduper73',       'swb',          'swblarge',      'swblux',
    'swbw',               'taus88',       'threefry',      'threefry2x64',
    'tinymt32',           'tinymt64',     'tylo64',        'v3b',
    'well1024a',          'weyl',         'wich1982',      'wich2006',
    'wob2m',              'wyrand',       'xabc16',        'xabc32',
    'xabc64',             'xabc8',        'xorgens',       'xoroshiro1024st',
