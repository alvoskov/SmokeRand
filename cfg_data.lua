...
local lib_headers = {'apidefs.h', 'cinterface.h', 'base64.h', 'blake2s.h', 'core.h',
    ...
    'hwtests.h', 'int128defs.h', 'lfsr_period.h', 'lfsr_period_factors.h',
    'lineardep.h', 'specfuncs.h',
...
local gen_sources = {
    ...
    'shr3',               'sirius64',           'sirius64_bad',       'skiss32', 
    ...
    'superduper73',       'superduper96',       'swb',                'swb53dec', 
    'swb64sc',            'swblarge',           'swblux',             'swblux64', 
    'swbmwc32',           'swbmwc64',           'swbw',               'taus88', 
    'tf0duper32',         'tf0duper64',         'tf0_128',            'tf0_32', 
    'tf0_32sc2',          'tf0_32sc3',          'tf0_64',             'tf0_64sc', 
    'tf0_64sc2',          'tf0_ctr64',          'threefish1024',      'threefry', 
    'threefry2x64',       'thurst',             'tinymt32',           'tinymt64', 
    'tt1600mrt',          'tt800',              'tychei',             'tychei64', 
    ...
    'xkiss8_awc',         'xorgens',            'xorgens1024',        'xorgens256', 
    'xorgens512',         'xormix32',           'xormix64',           'xormix64ctr', 
    ...
    'xoroshiro32pp',      'xoroshiro48w16ppp',  'xoroshiro48w8ppp',   'xoroshiro64aox', 
    'xoroshiro64pp',      'xoroshiro64st',      'xoroshiro64stst',    'xoroshiro64w16pp', 
    'xorrot128',          'xorrot128mn',        'xorrot128w32',       'xorrot128w32mrt', 
    'xorrot160',          'xorrot256',          'xorrot256mrt',       'xorrot32', 
    'xorrot320',          'xorrot512',          'xorrot512mrt',       'xorrot64', 
    ...
    'xorshift160',        'xorshift192',        'xorshift256',        'xorshift64', 
    'xorshift64st',       'xorshift7',          'xorshift96',         'xorwow', 
    ...
    'xtea2_64',           'xxtea',              'yasmarang',          'zibri128', 
