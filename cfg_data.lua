...
local gen_sources = {
    ...
    'coveyou64', 'cwg64', 'des', 'drand48', 'efiix64x48', 'flea32x1', 'hc256',
    'isaac64', 'kiss64', 'kiss93', 'kiss99', 'kuzn', 'lcg128', 'lcg32prime',
    'lcg64', 'lcg64prime', 'lcg69069', 'lcg96', 'lea', 'lfib4', 'lfib4_u64',
    'lfib_par', 'lfib_ranmar', 'lfsr113', 'lfsr258', 'loop_7fff_w64',
    'lrnd64_1023', 'lrnd64_255', 'lxm_64x128', 'macmarsa', 'magma', 'minstd',
    'mixmax', 'mlfib17_5', 'mrg32k3a', 'msws', 'msws64', 'msws_ctr', 'mt19937',
    'mulberry32', 'mwc128', 'mwc128x', 'mwc128xxa32', 'mwc1616', 'mwc1616x',
    'mwc256xxa64', 'mwc3232x', 'mwc32x', 'mwc32xxa8', 'mwc40xxa8', 'mwc4691',
    'mwc48xxa16', 'mwc64', 'mwc64x', 'pcg32', 'pcg32_xsl_rr', 'pcg64_64',
    'pcg64_xsl_rr', 'philox', 'philox2x32', 'philox32', 'r1279', 'ran', 'randu',
    'ranlux48', 'ranluxpp', 'ranq1', 'ranq2', 'ranrot32', 'ranrot_bi', 'ranshi',
    'ranval', 'rc4', 'rc4ok', 'romutrio', 'rrmxmx', 'sapparot', 'sapparot2',
    'sezgin63', 'sfc16', 'sfc32', 'sfc64', 'sfc8', 'shr3', 'speck128',
