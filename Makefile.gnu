...
LIB_SOURCES = $(addprefix $(SRCDIR)/, $(LIB_SOURCES_EXTRA) \
    ...
    blake2s.c entropy.c extratests.c fileio.c lfsr_period.c lfsr_period_factors.c \
...
LIB_HEADERS = $(addprefix $(INCLUDEDIR)/, $(LIB_HEADERS_EXTRA) \
    ...
    blake2s.h entropy.h extratests.h fileio.h lfsr_period.h lfsr_period_factors.h \
    lineardep.h hwtests.h specfuncs.h threads_intf.h utils.h version.h)
